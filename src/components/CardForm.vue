<template>
  <q-card style="width: 20vw; min-width: 350px" class="q-pb-md">
    <q-form @submit.prevent="submitForm()">
      ...
      <q-card-section align="right" class="q-gutter-x-md q-py-none q-mt-md">
        <q-btn color="grey-8" label="Cancel" type="reset" size="sm" v-close-popup>
          <q-tooltip>Cancel And Close</q-tooltip>
        </q-btn>
        <q-btn color="green-9" :label="buttonPrefix" type="submit" size="sm">
